...
train_data = "examples/Seat/Seat_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/Seat/Seat_test_lmdb"
...
name_size_file = "data/Seat/test_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/Seat/label_map_voc.prototxt"

# MultiBoxLoss parameters.
num_classes = 14
share_location = True
background_label_id = 13
